let express,RpcClient,fs;_818‍.x([["default",()=>_818‍.o]]);_818‍.w("express",[["default",["express"],function(v){express=v}]]);_818‍.w("bitcoind-rpc",[["default",["RpcClient"],function(v){RpcClient=v}]]);_818‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
...
fs.readFile('D:\\Kriptovalute\\clientConfig.txt', 'utf8' , (err, data) => {
  if (err) {
    _818‍.g.console.error(err);
    return;
  }
  _818‍.g.console.log(JSON.parse(data));
